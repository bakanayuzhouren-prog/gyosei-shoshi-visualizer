  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        // Note: The Gemini Service usually expects the raw base64 data, 
        // but for preview we need the full string. We'll strip it in the service call or here.
        // For simplicity in UI, we keep full string here.
